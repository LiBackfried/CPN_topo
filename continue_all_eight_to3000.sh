...
marker="$project_dir/out_data/.all_eight_to3000_started"
test ! -e "$marker"
...
for spec in \
  ...
  "ns_constraint_72_N21_4x2000_stoc5000 group_2000"; do
    ...
    for run in 0 1 2 3; do
        ...
        config="$project_dir/config_files/ns_constraint_72_N21_to3000/${config_prefix}_run_$run"
