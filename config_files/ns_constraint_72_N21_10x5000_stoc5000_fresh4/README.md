Fourth UBELIX batch: 10 fresh chains
...
```bash
sbatch run_ns_constraint_72_N21_10x5000_stoc5000_fresh4_ubelix.sh
```

Each chain starts fresh (start=1, rng_start=0), using seeds 46774 through 46783.
...
/scratch/network/users/lb25v444/out_data/ns_constraint_72_N21_10x5000_stoc5000_fresh4/job_<JOB_ID>/run_<0..9>/
